...
CollectedRepo=(13) ##示例：CollectedRepo=(2 6)
...
CR13() {
    ql repo https://gitee.com/jia_yuan/xdd-script.git "jd_|jx_|jdCookie" "activity|backUp" "^jd[^_]|USER|utils|function|sign|sendNotify|ql|JDJR"
}
