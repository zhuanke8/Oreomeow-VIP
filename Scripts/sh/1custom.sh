...
dl_extra_shell() {
    ...
    curl -s --connect-timeout 3 https://raw.githubusercontent.com/zhuanke8/VIP/main/Tasks/qlrepo/extra.sh > $extra_shell_path
...
dl_code_shell() {
    ...
    curl -s --connect-timeout 3 https://raw.githubusercontent.com/zhuanke8/VIP/main/Scripts/sh/Helpcode2.8/code.sh > $code_shell_path
...
dl_task_before_shell() {
    ...
    curl -s --connect-timeout 3 https://raw.githubusercontent.com/zhuanke8/VIP/main/Scripts/sh/Helpcode2.8/task_before.sh > $task_before_shell_path
